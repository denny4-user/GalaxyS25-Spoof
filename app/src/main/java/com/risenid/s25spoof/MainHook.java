...
public class MainHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {        
        ...
        try {
            // Hook SystemProperties.get() via reflection - NO DIRECT IMPORT NEEDED
            Class<?> systemPropertiesClass = XposedHelpers.findClass("android.os.SystemProperties", null);
            
            XposedHelpers.findAndHookMethod(systemPropertiesClass, "get", String.class, String.class,
                    new XC_MethodHook() {
                        @Override
            ...
            XposedBridge.log("GalaxyS25Spoof: SystemProperties hook applied ✓");

        } catch (Throwable e) {
            XposedBridge.log("GalaxyS25Spoof: Error hooking SystemProperties: " + e.getMessage());
            e.printStackTrace();
        }
        ...
        try {
            ...
            XposedBridge.log("GalaxyS25Spoof: Build class hook applied ✓");
        } catch (Throwable e) {
            XposedBridge.log("GalaxyS25Spoof: Error hooking Build class: " + e.getMessage());
        }
